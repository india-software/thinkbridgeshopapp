...
namespace ThinkBridge.Shop.Services.Customer
{
    public class TokenService : ITokenService
    {
        ...
        public ThinkBridgeToken GenerateAccessToken(IEnumerable<Claim> claims)
        {
            ...
            return new ThinkBridgeToken { AccessToken = new JwtSecurityTokenHandler().WriteToken(tokeOptions), ValidTo = tokeOptions.ValidTo.ToString("yyyy-MM-ddThh:mm:ss") };
        }
